...
export const removeBackground = async (imageElement: HTMLImageElement): Promise<Blob> => {
  try {
    ...
    // Create final canvas with 3:4 aspect ratio (3cm x 4cm at 300 DPI = 354x472 pixels)
    ...
    const scale = Math.min(finalCanvas.width / outputCanvas.width, finalCanvas.height / outputCanvas.height);
    ...
    finalCtx.drawImage(outputCanvas, x, y, scaledWidth, scaledHeight);
    console.log('Final image created with 3:4 aspect ratio');
